...
public class User {
  ...
  public User(int id, String firstName, String lastName, String email, String phone, char[] password, String language, String status, String privileges, Instant createdAt, Instant lastLoggedIn, Instant updatedAt) {
    this.id = id;
    ...
    this.last_logged_in = lastLoggedIn;
